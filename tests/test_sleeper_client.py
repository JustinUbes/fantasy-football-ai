...
from src.data.fantasy.sleeper import SleeperClient, SleeperLeague, SleeperUser
...
async def test_get_leagues_for_user(respx_mock):
    respx_mock.get("https://api.sleeper.app/v1/user/123456789/leagues/nfl/2024").mock(
        return_value=httpx.Response(200, json=MOCK_LEAGUES)
    )
